...
class Google_Service_YouTube_FanFundingEventListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_FanFundingEvent) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_FanFundingEvent');
      }
    }
    $this->items = $items;
  }
