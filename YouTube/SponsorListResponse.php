...
class Google_Service_YouTube_SponsorListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_Sponsor) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_Sponsor');
      }
    }
    $this->items = $items;
  }
