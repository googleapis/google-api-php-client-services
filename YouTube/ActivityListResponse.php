...
class Google_Service_YouTube_ActivityListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_Activity) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_Activity');
      }
    }
    $this->items = $items;
  }
