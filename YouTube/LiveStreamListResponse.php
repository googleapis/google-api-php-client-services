...
class Google_Service_YouTube_LiveStreamListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_LiveStream) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_LiveStream');
      }
    }
    $this->items = $items;
  }
