...
class Google_Service_YouTube_SubscriptionListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_Subscription) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_Subscription');
      }
    }
    $this->items = $items;
  }
