...
class Google_Service_YouTube_PlaylistListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_Playlist) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_Playlist');
      }
    }
    $this->items = $items;
  }
