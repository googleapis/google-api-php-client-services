...
class Google_Service_YouTube_VideoCategoryListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_VideoCategory) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_VideoCategory');
      }
    }
    $this->items = $items;
  }
