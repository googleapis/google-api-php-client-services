...
class Google_Service_YouTube_GuideCategoryListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_GuideCategory) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_GuideCategory');
      }
    }
    $this->items = $items;
  }
