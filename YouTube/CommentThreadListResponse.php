...
class Google_Service_YouTube_CommentThreadListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_CommentThread) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_CommentThread');
      }
    }
    $this->items = $items;
  }
