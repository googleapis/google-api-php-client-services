...
class Google_Service_YouTube_PlaylistItemListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_PlaylistItem) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_PlaylistItem');
      }
    }
    $this->items = $items;
  }
