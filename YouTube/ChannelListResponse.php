...
class Google_Service_YouTube_ChannelListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_Channel) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_Channel');
      }
    }
    $this->items = $items;
  }
