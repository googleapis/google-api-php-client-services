...
class Google_Service_YouTube_VideoListResponse extends Google_Collection
{
  ...
  {
    foreach ($items as $i) {
      if (!$i instanceof Google_Service_YouTube_Video) {
        throw new InvalidArgumentException('First argument to setItems must be an array of Google_Service_YouTube_Video');
      }
    }
    $this->items = $items;
  }
