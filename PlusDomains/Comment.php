...
class Google_Service_PlusDomains_Comment extends Google_Collection
{
  ...
  public function setInReplyTo(array $inReplyTo)
  {
    foreach ($inReplyTo as $i) {
      if (!$i instanceof Google_Service_PlusDomains_CommentInReplyTo) {
        throw new InvalidArgumentException('First argument to setInReplyTo must be an array of Google_Service_PlusDomains_CommentInReplyTo');
      }
    }
