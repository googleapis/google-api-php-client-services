...
class Google_Service_CloudMonitoring_ListTimeseriesResponse extends Google_Collection
{
  ...
  public function setTimeseries(array $timeseries)
  {
    foreach ($timeseries as $t) {
      if (!$t instanceof Google_Service_CloudMonitoring_Timeseries) {
        throw new InvalidArgumentException('First argument to setTimeseries must be an array of Google_Service_CloudMonitoring_Timeseries');
      }
    }
