...
class Google_Service_CloudTalentSolution_GoogleCloudTalentV4JobQuery extends Google_Collection
{
  protected $collection_key = 'locationFilters';
  protected $commuteFilterType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4CommuteFilter';
  protected $commuteFilterDataType = '';
  public $companies;
  public $companyDisplayNames;
  protected $compensationFilterType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompensationFilter';
  ...
  protected $locationFiltersType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4LocationFilter';
  protected $locationFiltersDataType = 'array';
  protected $publishTimeRangeType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4TimestampRange';
  protected $publishTimeRangeDataType = '';
  public $query;
  public $queryLanguageCode;

  /**
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4CommuteFilter
   */
  public function setCommuteFilter(Google_Service_CloudTalentSolution_GoogleCloudTalentV4CommuteFilter $commuteFilter)
  {
    $this->commuteFilter = $commuteFilter;
  }
  /**
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4CommuteFilter
   */
  ...
  /**
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompensationFilter
   */
  public function setCompensationFilter(Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompensationFilter $compensationFilter)
  {
    $this->compensationFilter = $compensationFilter;
  }
  /**
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompensationFilter
   */
  ...
  /**
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4LocationFilter[]
   */
  ...
  /**
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4LocationFilter[]
   */
  ...
  /**
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4TimestampRange
   */
  public function setPublishTimeRange(Google_Service_CloudTalentSolution_GoogleCloudTalentV4TimestampRange $publishTimeRange)
  {
    $this->publishTimeRange = $publishTimeRange;
  }
  /**
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4TimestampRange
   */
