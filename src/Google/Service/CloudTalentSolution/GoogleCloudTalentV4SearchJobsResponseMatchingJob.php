...
class Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponseMatchingJob extends Google_Model
{
  protected $commuteInfoType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponseCommuteInfo';
  ...
  /**
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponseCommuteInfo
   */
  public function setCommuteInfo(Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponseCommuteInfo $commuteInfo)
  {
    $this->commuteInfo = $commuteInfo;
  }
  /**
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponseCommuteInfo
   */
