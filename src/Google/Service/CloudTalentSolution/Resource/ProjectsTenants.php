...
class Google_Service_CloudTalentSolution_Resource_ProjectsTenants extends Google_Service_Resource
{
   ...
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompleteQueryResponse
   */
  public function completeQuery($tenant, $optParams = array())
  {
    $params = array('tenant' => $tenant);
    $params = array_merge($params, $optParams);
    return $this->call('completeQuery', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompleteQueryResponse");
  }
  /**
   ...
   * "projects/foo".
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4Tenant $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4Tenant
   */
  public function create($parent, Google_Service_CloudTalentSolution_GoogleCloudTalentV4Tenant $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4Tenant");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4Tenant");
  }
  /**
   ...
   * results.
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4ListTenantsResponse
   */
  public function listProjectsTenants($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4ListTenantsResponse");
  }
  /**
   ...
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4Tenant
   */
  public function patch($name, Google_Service_CloudTalentSolution_GoogleCloudTalentV4Tenant $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4Tenant");
  }
}
