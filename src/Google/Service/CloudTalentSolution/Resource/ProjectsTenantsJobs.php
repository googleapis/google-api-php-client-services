...
class Google_Service_CloudTalentSolution_Resource_ProjectsTenantsJobs extends Google_Service_Resource
{
   ...
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4BatchCreateJobsRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudTalentSolution_Operation
   */
  public function batchCreate($parent, Google_Service_CloudTalentSolution_GoogleCloudTalentV4BatchCreateJobsRequest $postBody, $optParams = array())
  {
   ...
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4BatchDeleteJobsRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudTalentSolution_Operation
   */
  public function batchDelete($parent, Google_Service_CloudTalentSolution_GoogleCloudTalentV4BatchDeleteJobsRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * "projects/{project_id}/tenants/{tenant_id}". For example,
   * "projects/foo/tenants/bar".
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4BatchUpdateJobsRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudTalentSolution_Operation
   */
  public function batchUpdate($parent, Google_Service_CloudTalentSolution_GoogleCloudTalentV4BatchUpdateJobsRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * "projects/{project_id}/tenants/{tenant_id}". For example,
   * "projects/foo/tenants/bar".
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4Job $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4Job
   */
  public function create($parent, Google_Service_CloudTalentSolution_GoogleCloudTalentV4Job $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4Job");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4Job");
  }
  /**
   ...
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4ListJobsResponse
   */
  public function listProjectsTenantsJobs($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4ListJobsResponse");
  }
  /**
   ...
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4Job
   */
  public function patch($name, Google_Service_CloudTalentSolution_GoogleCloudTalentV4Job $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4Job");
  }
  /**
   ...
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponse
   */
  public function search($parent, Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponse");
  }
  /**
   ...
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponse
   */
  public function searchForAlert($parent, Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('searchForAlert', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponse");
  }
}
