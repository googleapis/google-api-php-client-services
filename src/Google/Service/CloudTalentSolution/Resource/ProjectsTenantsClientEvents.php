...
class Google_Service_CloudTalentSolution_Resource_ProjectsTenantsClientEvents extends Google_Service_Resource
{
   ...
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4ClientEvent $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4ClientEvent
   */
  public function create($parent, Google_Service_CloudTalentSolution_GoogleCloudTalentV4ClientEvent $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4ClientEvent");
  }
}
