...
class Google_Service_CloudTalentSolution_Resource_ProjectsTenantsCompanies extends Google_Service_Resource
{
   ...
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4Company $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4Company
   */
  public function create($parent, Google_Service_CloudTalentSolution_GoogleCloudTalentV4Company $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4Company");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4Company");
  }
  /**
   ...
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4ListCompaniesResponse
   */
  public function listProjectsTenantsCompanies($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4ListCompaniesResponse");
  }
  /**
   ...
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4Company
   */
  public function patch($name, Google_Service_CloudTalentSolution_GoogleCloudTalentV4Company $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_CloudTalentSolution_GoogleCloudTalentV4Company");
  }
}
