...
class Google_Service_CloudTalentSolution_GoogleCloudTalentV4Company extends Google_Collection
{
  protected $collection_key = 'keywordSearchableJobCustomAttributes';
  public $careerSiteUri;
  protected $derivedInfoType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompanyDerivedInfo';
  ...
  /**
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompanyDerivedInfo
   */
  public function setDerivedInfo(Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompanyDerivedInfo $derivedInfo)
  {
    $this->derivedInfo = $derivedInfo;
  }
  /**
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompanyDerivedInfo
   */
