...
class Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponse extends Google_Collection
{
  protected $collection_key = 'matchingJobs';
  public $broadenedQueryJobsCount;
  protected $histogramQueryResultsType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4HistogramQueryResult';
  protected $histogramQueryResultsDataType = 'array';
  protected $locationFiltersType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4Location';
  protected $locationFiltersDataType = 'array';
  protected $matchingJobsType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponseMatchingJob';
  ...
  protected $spellCorrectionType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4SpellingCorrection';
  ...
  /**
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4HistogramQueryResult[]
   */
  ...
  /**
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4HistogramQueryResult[]
   */
  ...
  /**
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponseMatchingJob[]
   */
  ...
  /**
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4SearchJobsResponseMatchingJob[]
   */
  ...
  /**
   * @param Google_Service_CloudTalentSolution_GoogleCloudTalentV4SpellingCorrection
   */
  public function setSpellCorrection(Google_Service_CloudTalentSolution_GoogleCloudTalentV4SpellingCorrection $spellCorrection)
  {
    $this->spellCorrection = $spellCorrection;
  }
  /**
   * @return Google_Service_CloudTalentSolution_GoogleCloudTalentV4SpellingCorrection
   */
