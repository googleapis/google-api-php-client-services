...
class Google_Service_Dialogflow_Resource_ProjectsLocationsAgentsFlowsPages extends Google_Service_Resource
{
   ...
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Page $postBody
   ...
   */
  public function create($parent, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Page $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Page");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Page");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ListPagesResponse
   */
  public function listProjectsLocationsAgentsFlowsPages($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ListPagesResponse");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Page
   */
  public function patch($name, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Page $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Page");
  }
}
