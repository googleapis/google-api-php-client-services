...
class Google_Service_Dialogflow_Resource_ProjectsLocationsAgentsEnvironments extends Google_Service_Resource
{
   ...
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Environment $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Dialogflow_GoogleLongrunningOperation
   */
  public function create($parent, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Environment $postBody, $optParams = array())
  {
   ...
   * `projects//locations//agents//environments/`.
   * @param array $optParams Optional parameters.
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Environment
   */
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Environment");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse
   */
  public function listProjectsLocationsAgentsEnvironments($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse");
  }
  /**
   ...
   * @opt_param string pageToken The next_page_token value returned from a
   * previous list request.
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse
   */
  public function lookupEnvironmentHistory($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('lookupEnvironmentHistory', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleLongrunningOperation
   */
  public function patch($name, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Environment $postBody, $optParams = array())
  {
