...
class Google_Service_Dialogflow_Resource_ProjectsLocationsAgentsEntityTypes extends Google_Service_Resource
{
   ...
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1EntityType $postBody
   ...
   * used.
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1EntityType
   */
  public function create($parent, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1EntityType $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1EntityType");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1EntityType");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ListEntityTypesResponse
   */
  public function listProjectsLocationsAgentsEntityTypes($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ListEntityTypesResponse");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1EntityType
   */
  public function patch($name, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1EntityType $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1EntityType");
  }
}
