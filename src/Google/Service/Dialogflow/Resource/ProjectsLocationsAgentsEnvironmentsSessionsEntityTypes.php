...
class Google_Service_Dialogflow_Resource_ProjectsLocationsAgentsEnvironmentsSessionsEntityTypes extends Google_Service_Resource
{
   ...
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SessionEntityType $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SessionEntityType
   */
  public function create($parent, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SessionEntityType $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SessionEntityType");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SessionEntityType");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ListSessionEntityTypesResponse
   */
  public function listProjectsLocationsAgentsEnvironmentsSessionsEntityTypes($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ListSessionEntityTypesResponse");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SessionEntityType
   */
  public function patch($name, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SessionEntityType $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SessionEntityType");
  }
}
