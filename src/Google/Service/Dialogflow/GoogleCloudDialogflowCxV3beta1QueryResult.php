...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1QueryResult extends Google_Collection
{
  ...
  protected $intentType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Intent';
  ...
  public $parameters;
  protected $responseMessagesType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ResponseMessage';
  protected $responseMessagesDataType = 'array';
  protected $sentimentAnalysisResultType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SentimentAnalysisResult';
   ...
   */
  public function setIntent(Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Intent $intent)
  {
    $this->intent = $intent;
  }
  /**
  ...
  /**
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SentimentAnalysisResult
   */
  public function setSentimentAnalysisResult(Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SentimentAnalysisResult $sentimentAnalysisResult)
  {
    $this->sentimentAnalysisResult = $sentimentAnalysisResult;
  }
  /**
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SentimentAnalysisResult
   */
