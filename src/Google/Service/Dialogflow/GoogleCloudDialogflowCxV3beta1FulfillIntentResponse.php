...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1FulfillIntentResponse extends Google_Model
{
  public $outputAudio;
  ...
  protected $queryResultType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1QueryResult';
  ...
  /**
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1QueryResult
   */
  public function setQueryResult(Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1QueryResult $queryResult)
  {
    $this->queryResult = $queryResult;
  }
  /**
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1QueryResult
   */
