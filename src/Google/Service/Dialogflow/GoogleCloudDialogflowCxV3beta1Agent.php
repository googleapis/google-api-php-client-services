...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Agent extends Google_Model
{
  public $avatarUri;
  ...
  public $name;
  protected $speechToTextSettingsType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SpeechToTextSettings';
  ...
  /**
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SpeechToTextSettings
   */
  public function setSpeechToTextSettings(Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SpeechToTextSettings $speechToTextSettings)
  {
    $this->speechToTextSettings = $speechToTextSettings;
  }
  /**
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1SpeechToTextSettings
   */
