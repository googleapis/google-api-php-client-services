...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1Flow extends Google_Collection
{
  ...
  public $name;
  protected $nluSettingsType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1NluSettings';
  ...
  /**
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1NluSettings
   */
  public function setNluSettings(Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1NluSettings $nluSettings)
  {
    $this->nluSettings = $nluSettings;
  }
  /**
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1NluSettings
   */
