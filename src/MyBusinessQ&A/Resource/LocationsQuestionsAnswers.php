...
namespace Google\Service\MyBusinessQ&A\Resource;

use Google\Service\MyBusinessQ&A\Answer;
use Google\Service\MyBusinessQ&A\ListAnswersResponse;
use Google\Service\MyBusinessQ&A\UpsertAnswerRequest;

/**
 * The "answers" collection of methods.
 * Typical usage is:
 *  <code>
 *   $mybusinessqandaService = new Google\Service\MyBusinessQ&A(...);
...
class_alias(LocationsQuestionsAnswers::class, 'Google_Service_MyBusinessQ&A_Resource_LocationsQuestionsAnswers');
