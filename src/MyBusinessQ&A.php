 ...
 * @author Google, Inc.
 */
class MyBusinessQ&A extends \Google\Service
{
  ...
  /**
   * Constructs the internal representation of the MyBusinessQ&A service.
   *
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->locations_questions = new MyBusinessQ&A\Resource\LocationsQuestions(
        $this,
        $this->serviceName,
        'questions',
        [
    ...
    $this->locations_questions_answers = new MyBusinessQ&A\Resource\LocationsQuestionsAnswers(
        $this,
        $this->serviceName,
        'answers',
        [
...
class_alias(MyBusinessQ&A::class, 'Google_Service_MyBusinessQ&A');
